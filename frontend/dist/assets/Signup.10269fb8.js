import{s as p,C as _,u as j,r as u,g as k,h as R,d as W,e as G,j as c,a as e,B as N,c as X,f as q}from"./index.f642262d.js";import{S as D}from"./SingleInput.062eb0c9.js";var H=/^[-!#$%&'*+\/0-9=?A-Z^_a-z{|}~](\.?[-!#$%&'*+\/0-9=?A-Z^_a-z`{|}~])*@[a-zA-Z0-9](-*\.?[a-zA-Z0-9])*\.[a-zA-Z](-?[a-zA-Z0-9])+$/,J=function(r){if(!r||r.length>254)return!1;var n=H.test(r);if(!n)return!1;var i=r.split("@");if(i[0].length>64)return!1;var g=i[1].split(".");return!g.some(function(f){return f.length>63})};const K=p.div`
  display: flex;
