import{s as p,C as _,u as V,r as u,h as j,k as R,c as W,d as G,j as c,a as e,b as N,e as X}from"./index.fbe81bbb.js";import{S as q,B as D}from"./SingleInput.f833c64e.js";var H=/^[-!#$%&'*+\/0-9=?A-Z^_a-z{|}~](\.?[-!#$%&'*+\/0-9=?A-Z^_a-z`{|}~])*@[a-zA-Z0-9](-*\.?[a-zA-Z0-9])*\.[a-zA-Z](-?[a-zA-Z0-9])+$/,J=function(r){if(!r||r.length>254)return!1;var n=H.test(r);if(!n)return!1;var i=r.split("@");if(i[0].length>64)return!1;var g=i[1].split(".");return!g.some(function(h){return h.length>63})};const K=p.div`
  display: flex;
