...
`,l=s.img`
  ...
  height: 48px;
  padding: 0.25rem;
`;function w(){const{i18n:e}=h(),a=p(o=>o.setRoute);return d.exports.useEffect(()=>{a({name:"languages",forAny:!0,showBackButton:!0})},[]),n(m,{children:[n(r,{onClick:()=>{e.changeLanguage("en")},children:[t(c,{as:i,hide:e.languages[0]!=="en"}),t(l,{src:f})]}),n(r,{onClick:()=>{e.changeLanguage("tr")},children:[t(c,{as:i,hide:e.languages[0]!=="tr"}),t(l,{src:x})]})]})}export{w as default};
